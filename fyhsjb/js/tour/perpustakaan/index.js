...
function assets() {
	var allassets;
	for(var i=1; i<=9; i++) {
		allassets = allassets + '<img id="' + i + '" src="../images/perpustakaan/(' + i + ').webp" rotation="0 -90 0">';
	}
	for(var i=1; i<=10; i++) {
		allassets = allassets + '<img id="' + (i+9) + '" src="../images/perpustakaan/1/(' + i + ').webp" rotation="0 -90 0">';
	}
	for(var i=1; i<=22; i++) {
		allassets = allassets + '<img id="' + (i+19) + '" src="../images/perpustakaan/2/(' + i + ').webp" rotation="0 -90 0">';
	}
	for(var i=1; i<=5; i++) {
		allassets = allassets + '<img id="' + (i+41) + '" src="../images/perpustakaan/3/(' + i + ').webp" rotation="0 -90 0">';
	}
	for(var i=1; i<=18; i++) {
		allassets = allassets + '<img id="' + (i+46) + '" src="../images/perpustakaan/4/(' + i + ').webp" rotation="0 -90 0">';
	}
