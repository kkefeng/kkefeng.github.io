...
function addassets() {
  document.getElementById("moreassets").innerHTML +=  '<img id="qr" src="../qr.png">';
  document.getElementById("moreassets").innerHTML +=  '<img id="cola" src="../rubbish/cola.png">';
  document.getElementById("moreassets").innerHTML +=  '<img id="cardboard" src="../rubbish/cardboard.png">';
  document.getElementById("moreassets").innerHTML +=  '<img id="paper" src="../rubbish/paper.png">';
  document.getElementById("moreassets").innerHTML +=  '<img id="plasticb" src="../rubbish/plasticb.png">';
  document.getElementById("moreassets").innerHTML +=  '<img id="plasticc" src="../rubbish/plasticc.png">';
