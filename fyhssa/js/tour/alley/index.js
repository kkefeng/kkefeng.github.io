...
function assets() {
	var allassets;
	for(var i=1; i<=8; i++) {
		allassets = allassets + '<img id="' + (i) + '" src="../images/alley/(' + i + ').webp" rotation="0 -90 0">';
	}
	document.getElementById("assets").innerHTML = allassets;
}

function spheres() {
	var all = '<a-entity class="scene1"><a-sphere id="box1" color="red" onclick="run(1)" position="30 -5 0" radius="0.001" material="" geometry=""> </a-sphere></a-entity>';
		var i = 2;
