...
function clearAll() {
	...
	document.getElementById('litang').style.display = "none";
...
function spheres() {
	var all = '<a-entity class="scene1"><a-sphere id="box1" color="red" onclick="run(1)" position="27 -5 -3" radius="0.001" material="" geometry=""> </a-sphere></a-entity>';
		var i = 2;
  ...
  function closeNav() {
   ...
   function changetitle(a) {
  	if(a == 1) {
  		...
  		document.getElementById('litang').style.display = "block";
  	} else if(a == 3) {
